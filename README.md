...
6. （任意）「🎬 3D生成」で忠実プレビューを生成（Unity + lilToon/Poiyomi が必要。詳細は下記）。
...
| `cli.ts` | scan / list / search / detect / diff / save-template / restore-template / installs / catalog / dupes / products / reclaim / render / caps |
